...
//
//
//public class _IconImageView: UIImageView {
...
////    }
//    
//    public func setIconConfiguration(pointSize: CGFloat, weight: UIImage.SymbolWeight = .regular, scale: UIImage.SymbolScale = .medium) {
//        let newConfig = UIImage.SymbolConfiguration(pointSize: pointSize, weight: weight, scale: scale)
//        self.currentConfig = newConfig
//        updateImage()
//    }
